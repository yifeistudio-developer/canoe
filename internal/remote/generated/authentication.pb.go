...
var file_proto_authentication_proto_rawDesc = []byte{
	...
	0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x0d,
...
func file_proto_authentication_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_authentication_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_authentication_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_proto_authentication_proto_msgTypes[2].Exporter = func(v any, i int) any {
